\doxysection{HW4\+\_\+\+ME507.\+github.\+io/\+Src/main.c File Reference}
\hypertarget{main_8c}{}\label{main_8c}\index{HW4\_ME507.github.io/Src/main.c@{HW4\_ME507.github.io/Src/main.c}}
...
\begin{DoxyCompactList}\small\item\em specifies the timer used for one of the motors \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em used for callback function and to communicate with device \end{DoxyCompactList}\item 
\Hypertarget{main_8c_a9dc217b6fe0e846d832ab6166263d727}\label{main_8c_a9dc217b6fe0e846d832ab6166263d727} 
char {\bfseries char\+\_\+in} \mbox{[}5\mbox{]}
\begin{DoxyCompactList}\small\item\em stores the values from the user \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em variable to specify what state it is in and when it is appropriate to move on to the next state \end{DoxyCompactList}\item 
\Hypertarget{main_8c_af09ff1950046bd7b7e24206842bdb75f}\label{main_8c_af09ff1950046bd7b7e24206842bdb75f} 
int {\bfseries pw}
\begin{DoxyCompactList}\small\item\em sets appropriate pulse width for the motor \end{DoxyCompactList}\item 
\Hypertarget{main_8c_a1120e2496b2033965932bb739630204b}\label{main_8c_a1120e2496b2033965932bb739630204b} 
char {\bfseries HEX} \mbox{[}2\mbox{]}
\begin{DoxyCompactList}\small\item\em defines the hexadecimal value for the duty cycle for the motor \end{DoxyCompactList}\end{DoxyCompactItemize}
...
A function that handles a user\textquotesingle{}s keyboard input and "{}echos"{} the result. No more than five characters are allowed. 
\begin{DoxyParams}{Parameters}
{\em count} & defines how many characters are input \\
\hline
{\em char\+\_\+in} & stores the values from the user\\
\hline
\end{DoxyParams}
